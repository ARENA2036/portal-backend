...
public class CompanyRepositoryTests : IAssemblyFixture<TestDbFixture>
{
    ...
    public async Task GetCompanyRoleAndConsentAgreementDetailsAsync_ReturnsExpected()
    {
        ...
        var serviceDscription = "The Service Provider is able to offer 3rd party services, such as dataspace service offerings to Arena-X Members. Arena-X members can subscribe for those services.";
        ...
        var onboardingServiceProviderDescription = "The Onboarding service provider is a Arena-X certified role which enables the company to act as onboarding provider inside the network.";
